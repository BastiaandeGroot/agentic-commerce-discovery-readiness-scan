...
export const METHODE = {
  ...
  en: {
    ...
    questionsBank:
      'Such a bank is built by working through five sites in your market — category leaders, specialists, brands, and often a German player because they publish more technical detail — and writing down which questions keep coming back. Per question we note on how many of those sites the topic appears. That is not a measurement of how often customers ask it, but it is traceable, and it is a good deal stronger than the judgement of one shop.',
    questionsWeight:
