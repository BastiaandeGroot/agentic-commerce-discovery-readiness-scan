...
export const STRINGS = {
  nl: {
    ...
    questions: {
      ...
      suggestionsTitle: 'Attributen die je zelf bijhoudt',
      suggestionsIntro:
        'Deze kenmerken staan in je eigen data. Ze tellen niet mee — dat jij iets registreert zegt namelijk nog niet dat een koper ernaar vraagt. Maar hoort er wél een kopersvraag bij, til hem dan op en formuleer hem in de woorden van je klant.',
      suggestionFromFeed: 'Uit je feed',
      suggestionFromCatalog: 'Uit je PIM',
      suggestionFilled: 'gevuld',
      promote: 'Maak er een vraag van',
      noSuggestions: 'Geen losse attributen gevonden in deze categorie.',
  ...
  en: {
    ...
    questions: {
      ...
      suggestionsTitle: 'Attributes you maintain yourself',
      suggestionsIntro:
        'These characteristics sit in your own data. They do not count — the fact that you record something does not yet mean a buyer asks for it. But if there is a buyer question behind it, promote it and phrase it in your customer\'s words.',
      suggestionFromFeed: 'From your feed',
      suggestionFromCatalog: 'From your PIM',
      suggestionFilled: 'filled',
      promote: 'Turn into a question',
      noSuggestions: 'No loose attributes found in this category.',
