  ...
  nl: {
    ...
    admin: {
      ...
      issues: {
        ...
        'not-scored': 'Telt niet mee in de score',
      } as Record<string, string>,
      issueHelp: {
        ...
        'not-scored': 'Deze vraag is uit geen enkel kenmerk te beantwoorden en telt daarom niet mee in de score. Dat is goed: procesvragen horen in de bank te staan om het advies, maar zouden de meting vertekenen.',
      } as Record<string, string>,
  ...
  en: {
    ...
    admin: {
      ...
      issues: {
        ...
        'not-scored': 'Does not count towards the score',
      } as Record<string, string>,
      issueHelp: {
        ...
        'not-scored': 'This question cannot be answered from any characteristic and therefore does not count towards the score. That is right: process questions belong in the bank for the advice, but would distort the measurement.',
      } as Record<string, string>,
