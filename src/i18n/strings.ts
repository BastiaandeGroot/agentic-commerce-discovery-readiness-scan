  ...
  nl: {
    ...
    pages: {
      ...
      dashboard: {
        ...
        snapshotSummary: 'Samenvatting',
        snapshotCategories: 'Per categorie',
        snapshotQuestions: 'Onbeantwoorde vragen',
    ...
    report: {
      ...
      qualifiedInfo:
        'Het aantal producten waarvoor je catalogus álle kritieke vragen beantwoordt: de vragen die een aankoopfout voorkomen die de koper niet kan terugdraaien. Het telt de vragen van elke categorie waar het product onder hangt, niet alleen de eerste. Beantwoord betekent: het veld is gevuld en zegt genoeg. Leeg, te mager of maar deels telt niet. Vragen die je uitzette en vragen buiten de score doen niet mee. Kent een categorie geen kritieke vragen, dan telt elk product daarin hier mee. De balk zet dit af tegen alle producten in de scan, ook die zonder categorie; die komen hier nooit door.',
      qualifiedNoCritical:
  ...
  en: {
    ...
    pages: {
      ...
      dashboard: {
        ...
        snapshotCategories: 'Per category',
        snapshotQuestions: 'Unanswered questions',
    ...
    report: {
      ...
      qualifiedInfo:
        'The number of products for which your catalogue answers all critical questions: the questions that prevent a purchase mistake the buyer cannot undo. It counts the questions of every category the product sits under, not just the first. Answered means: the field is filled and says enough. Empty, too thin or only partial does not count. Questions you switched off and questions outside the score do not take part. If a category has no critical questions, every product in it counts here. The bar compares this with all products in the scan, including those without a category; those never pass here.',
      qualifiedNoCritical:
