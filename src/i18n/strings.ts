...
export const STRINGS = {
  nl: {
    ...
    shopScan: {
      ...
      pagesTitle: 'Welke pagina\u2019s we bekeken hebben',
      pagesBody: 'De steekproef, om na te lopen. Gespreid over de categorie\u00ebn, niet de eerste die we tegenkwamen.',
  ...
  en: {
    ...
    shopScan: {
      ...
      pagesTitle: 'Which pages we looked at',
      pagesBody: 'The sample, so you can check it. Spread across the categories, not the first ones we came across.',
