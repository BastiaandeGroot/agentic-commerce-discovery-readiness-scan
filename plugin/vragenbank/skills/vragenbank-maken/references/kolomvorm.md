...
| `modus` | Altijd `alle`: de scan telt een vraag pas als beantwoord als élk genoemd attribuut er staat. `een` wordt niet gevolgd. Noem daarom alleen de attributen die het antwoord werkelijk dragen. |
