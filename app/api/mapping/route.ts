...
const SYSTEM_EXPLAIN = [
  ...
  '- Deze winkelier heeft eigenschappen als afdeling neergezet. Dan weet hij het alleen van de producten',
  '  die hij in die afdeling legde, en van al zijn andere producten weet niemand het.',
  ...
  '',
  'Zin 1: het verschil, met één van zijn afdelingen en één van zijn eigenschappen als voorbeeld.',
  'Zin 2: wat er dan misgaat — hij weet het alleen van de producten in die afdeling, van de rest niet.',
  'Zin 3: wat het hem kost, in klanten of verkoop, als iemand daarop zoekt.',
  '',
  ...
  'verfijnen, veld, systeem, structuur, model, AI, assistent, agent, waar of onwaar, true, false.',
  '',
  'Zeg in plaats daarvan: afdeling, eigenschap, staat erbij, weet niemand, vindt niet, klant die zoekt.',
  '',
